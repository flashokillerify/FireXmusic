...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "firextechchat")
PROJECT_NAME = getenv("PROJECT_NAME", "FireXmusix")
SOURCE_CODE = getenv("SOURCE_CODE", "github.com/flashokillerify/firexmusic")
